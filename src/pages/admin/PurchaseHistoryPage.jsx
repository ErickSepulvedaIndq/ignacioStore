      ...
      <div className="bg-white rounded-lg shadow p-4 mb-6 border border-gray-100">
        <div className="mb-4">
          ...
          <select
            ...
            className={`md:w-1/1 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#3041A0] focus:border-[#3041A0] ${!grayText && selectedUserId === "" ? "text-gray-500" : "text-gray-900"
              }`}
